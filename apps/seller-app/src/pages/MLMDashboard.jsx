...
function MLMDashboard({ member, onLogout }) {
  ...
  function loadMLMData() {
    try {
      ...
      const savedLeft = localStorage.getItem(
        "justbrand_mlm_left_team"
      );

      if (savedLeft) {
        const data = JSON.parse(savedLeft);
      ...
      const savedRight = localStorage.getItem(
        "justbrand_mlm_right_team"
      );

      if (savedRight) {
        const data = JSON.parse(savedRight);
          ...
          {activeMenu === "dashboard" && (
            <>
              ...
              <section style={styles.section}>
                ...
                <p style={styles.sectionSubtitle}>
                  Invite new members to JustBrand
                  Family.
                </p>
            ...
            >
              ...
              {transactions.length === 0 ? (
                <div style={styles.emptyBox}>
                  ...
                  <p>
                    Your income history will appear
                    here.
                  </p>
